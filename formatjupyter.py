...
def processFileMain(allFilesMain):
    ...
    for programName in allFilesMain:
        ...
        fileo.write(f"# 🟩 {fullfilename}:  {dirName} \n")
                ...
                if bool(line.strip()):  # block empty lines
                    if "# %%" in line[0:4]:
                        ...
                        if bool(line[4:-1].strip()):
                            ...
                            headerWritten = True
                            if line[5:6] == " ":
                                print("space first position header", index01)
                        fileo.write(f"{p1}\n")
                        p1Open = True
                        fileo.write(line)
                    else:
...
dirName = "Z:/SharedA/Repos/data"
fileOutput = "Z:/SharedA/Repos/data/jupoutput.txt"
programLocation = "Z:/SharedA/Repos/Test/formatjupyter.py"
...
fileo.close()
print("------------------------------------- ")
print("formatjupyter version 001 Termination")
print("Result File       : ", fileOutput)
